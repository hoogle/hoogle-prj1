...
$option_items = array(
    'list_all' => array('url' => '/l10n/list_all', 'text' => 'List all'),
    'add' => array('url' => '/l10n/add', 'text' => 'New one'),
);
        ...
        <ul>
           <?php
            ...
            ?><li<?php echo (isset($data['items'])) ? '' : ' class="yui-menuitem"'; ?>>
                <?php if (isset($data['items'])) : ?><a class="yui-menu-label <?php echo $index; ?><?php echo $class; ?>" href="<?php echo $data['url']; ?>"><em><?php echo $data['text']; ?></em></a>
                <?php else : ?><a class="yui-menuitem-content <?php echo $index; ?><?php echo $class; ?>" href="<?php echo $data['url']; ?>"><?php echo $data['text']; ?></a>
                <?php endif; ?>

                <?php if (isset($data['items'])) : ?><div class="yui-menu">
                    <div class="yui-menu-content">
                        <ul>
                            <?php
                                $y = 0;
