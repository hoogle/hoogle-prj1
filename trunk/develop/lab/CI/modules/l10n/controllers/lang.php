...
class Lang extends Controller
{
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    $this->_browser_lang = (is_null($lang_country)) ? "en_US" : mb_strtolower($lang_lang) . "_" . mb_strtoupper($lang_country);
                    $this->_browser_lid = $lang_arr[$this->_browser_lang]['l_id'];
                }
            }
        }
    ...
    public function gen_page_cate()
    {
        ...
        $gen_str = "<?php\n\n";
        $gen_str.= "// This page category array was been generated by l10n/lang/gen_page_cate.\n\n";
        $gen_str.= $arr_str;
        $gen_str.= "?>";
